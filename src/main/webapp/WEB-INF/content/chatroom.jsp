...
<script>
    $(document).ready(function() {
        ...
        if ('WebSocket' in window) {
			websocket = new WebSocket("ws://106.14.224.239:8080/Spring-websocket/ws?uid="+${sessionScope.uid});
		} else if ('MozWebSocket' in window) {
			websocket = new MozWebSocket("ws://106.14.224.239:8080/Spring-websocket/ws"+${sessionScope.uid});
		} else {
			websocket = new SockJS("http://106.14.224.239:8080/Spring-websocket/ws/sockjs"+${sessionScope.uid});
		}
        //var websocket = new WebSocket('ws://106.14.224.239:8080/Spring-websocket/ws');
